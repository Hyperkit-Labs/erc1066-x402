...
contract VerifyHyperion is Script {
    function run() external {
        ...
        console.log(
            "  --constructor-args $(cast abi-encode 'constructor(address)' 0x92C73F9f972Bb0bdC8e3c5411345695F2E3710D0)"
        );
        console.log("");
        ...
        console.log(
            "  --constructor-args $(cast abi-encode 'constructor(address)' 0xE754b6Ce911511A0D7b3A5d2d367dB305B7a7f24)"
        );
    }
}

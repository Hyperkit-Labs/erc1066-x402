import { StatusCode, HttpResponse } from "../types/status";

export const STATUS_CODE_MAP: Record<StatusCode, HttpResponse> = {
...
export function mapStatusToHttp(status: StatusCode): HttpResponse {
